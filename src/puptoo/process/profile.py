    ...
    if ansible_info:
        try:
            ...
            if ansible_info.receptor_version:
                ansible["receptor_version"] = ansible_info.receptor_version
            if ansible_info.runner_version:
                ansible["runner_version"] = ansible_info.runner_version
            if ansible_info.eda_controller_version:
                ansible["eda_controller_version"] = ansible_info.eda_controller_version
            if ansible_info.gateway_version:
                ansible["gateway_version"] = ansible_info.gateway_version
        except Exception as e:

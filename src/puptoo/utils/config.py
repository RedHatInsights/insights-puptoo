...
if CLOWDER_ENABLED:
    ...
    KAFKA_SASL_USERNAME = os.getenv("KAFKA_SASL_USERNAME", LoadedConfig.kafka.brokers[0].sasl.username)
    KAFKA_SASL_PASSWORD = os.getenv("KAFKA_SASL_PASSWORD", LoadedConfig.kafka.brokers[0].sasl.password)

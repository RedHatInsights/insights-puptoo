...
class TestFlagDefaults:
    def test_qpc_processing_enabled_defaults_false(self):
        assert FLAG_FALLBACK_VALUES["puptoo.qpc-processing-enabled"] is False
...
class TestEnvVarOverrides:
    ...
    def test_hosts_transformation_can_be_enabled(self, monkeypatch):
        monkeypatch.setenv("QPC_HOSTS_TRANSFORMATION_ENABLED", "true")

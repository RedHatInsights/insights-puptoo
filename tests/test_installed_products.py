...
def test_installed_products():
    ...
    input_data.add(
        Specs.subscription_manager_installed_product_ids, INSTALLED_PRODUCTS_1
    )
    ...
    input_data = InputData()
    input_data.add(
        Specs.subscription_manager_installed_product_ids, INSTALLED_PRODUCTS_2
    )
    result = run_test(system_profile, input_data)
    assert result["installed_products"] == [
        {"id": "69", "name": "Red Hat Enterprise Linux Server"},
    ...
    input_data = InputData()
    input_data.add(
        Specs.subscription_manager_installed_product_ids, INSTALLED_PRODUCTS_3
    )
    result = run_test(system_profile, input_data)
    ...
    input_data = InputData()
    input_data.add(
        Specs.subscription_manager_installed_product_ids, INSTALLED_PRODUCTS_4
    )
    result = run_test(system_profile, input_data)
    assert result["installed_products"] == [
        {"id": "69", "name": "Red Hat Enterprise Linux Server"},
    ...
    input_data = InputData()
    input_data.add(
        Specs.subscription_manager_installed_product_ids, INSTALLED_PRODUCTS_5
    )
    result = run_test(system_profile, input_data)
    assert result["installed_products"] == [
        {"id": "69", "name": "Red Hat Enterprise Linux Server"},

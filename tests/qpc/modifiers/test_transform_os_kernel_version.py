...
def test_transform_os_kernel_field():
    ...
    assert (
        "os_kernel_version from '3.10.0-1127.el7.x86_64' to '3.10.0'"
...
def test_do_not_transform_os_kernel_field():
    host = {
        "system_profile": {
            "os_release": "7",
...
def test_transform_os_kernel_field_with_special_value():
    host = {
        "system_profile": {
            "key_a": "va",
            "os_kernel_version": "6.12.48+deb13",
        }
    }
    transformed_obj = {"modified": []}
    TransformOsKernelVersion().run(host, transformed_obj)
    ...
    host = {
        "system_profile": {
            "key_a": "va",
            "os_kernel_version": "5.11.5.ppa.el.x86_64",
        }
    }
    transformed_obj = {"modified": []}
    TransformOsKernelVersion().run(host, transformed_obj)
    ...
    host = {
        "system_profile": {
            "key_a": "va",
            "os_kernel_version": "4.14.44.solos2",
        }
    }
    transformed_obj = {"modified": []}
    TransformOsKernelVersion().run(host, transformed_obj)
